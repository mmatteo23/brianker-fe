...
export const USDCAddress =
  "0xe72f289584eda2be69cfe487f4638f09bac920db" as `0x${string}`;
export const SuperUSDCAddress =
  "0xb598E6C621618a9f63788816ffb50Ee2862D443B" as `0x${string}`;

// TODO: move this inside a DB or other resource
export const gymSmartAccount =
  "0xfecb6633E74d55Ce6f17387F767B4BEaF541Ab0b" as `0x${string}`;
export const gymUserFee = 50; // 50 USDC per month
export const gymUserMaxCashbackPercentage = 0.2;
export const flowRate = parseEther(
  (
    (gymUserFee * gymUserMaxCashbackPercentage) /
    ((365 / 12) * 24 * 60 * 60)
  ).toFixed(18),
);
...
export const fUSDCABI = [
  {
    inputs: [
      ...
      { internalType: "uint8", name: "initDecimals", type: "uint8" },
